...
namespace DotNetCoreKoans.Koans
{
    public class AboutStrings : Koan
    {
        ...
        {
            //character is escaping from its normal role w/in the compiler
...
broken line";
        ...
        public void ACrossPlatformWayToHandleLineEndings()
        {
            ...
            //use this because line ending syntax is different on Windows vs. Linux
...
broken line";
        ...
        public void PlusEqualsWillModifyTheTargetString()
        {
            ...
            var strB = "World";
            strA += strB;
            //string plus/equals modifies target string, not second (position A vs B)
		...
		{
            //LOOK AT THIS FOR AN AWESOME EXAMPLE OF INTERPOLATING IN AN ARGUMENT
		...
		{
            //here you are modifying the first item following the argument"{0}" and telling it what you want the modification to be :00, e.g., have at least two decimals
